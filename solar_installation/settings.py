"""
Django settings for solar_installation project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-!krwg5lo9m^xw(-uku*z_b0yhcnv#kjq##30k^+axqgia7$mus')
...
ROOT_URLCONF = 'solar_installation.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.user_notes',
                'core.context_processors.active_notices',
                'core.context_processors.admin_quotations',
            ],
        },
    },
...
WSGI_APPLICATION = 'solar_installation.wsgi.application'
